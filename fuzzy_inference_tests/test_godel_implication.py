...
import unittest
from fuzzy_implication import GodelImplicationSolver
from parser import parse_fuzzy_set


class TestGodelImplicationSolver(unittest.TestCase):

    def setUp(self):
        self.solver = GodelImplicationSolver()
    ...
    def test_equal_values(self):
        left_set = parse_fuzzy_set('A = {<x1, 0.5>, <x2, 0.7>}')
        right_set = parse_fuzzy_set('B = {<y1, 0.5>, <y2, 0.7>}')
    ...
    def test_all_ones(self):
        left_set = parse_fuzzy_set('A = {<x1, 1.0>, <x2, 1.0>}')
        right_set = parse_fuzzy_set('B = {<y1, 1.0>, <y2, 1.0>}')
    ...
    def test_all_zeros(self):
        left_set = parse_fuzzy_set('A = {<x1, 0.0>, <x2, 0.0>}')
        right_set = parse_fuzzy_set('B = {<y1, 0.0>, <y2, 0.0>}')
